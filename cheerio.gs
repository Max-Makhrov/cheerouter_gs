// just a copy of Cheerio library for GAS
function invokeCheerio() {
...
var loadCheerio_1 = __webpack_require__(4);
/**
 * The default cheerio instance.
 *
 * @deprecated Use the function returned by `loadCheerio` instead.
 */
exports["default"] = loadCheerio_1.loadCheerio([]);
var staticMethods = tslib_1.__importStar(__webpack_require__(6));
/**
 ...
 *
 * ```js
 * const $ = cheerio.loadCheerio('<div><p></p></div>');
 *
 ...
 * "loadCheerioed" Cheerio factory function.
 *
 ...
 * instead use the `root` static method of a "loadCheerioed" Cheerio function.
 *
 * @deprecated
 * @example
 *
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.loadCheerio = void 0;
var tslib_1 = __webpack_require__(2);
var options_1 = tslib_1.__importStar(__webpack_require__(5));
var staticMethods = tslib_1.__importStar(__webpack_require__(6));
var cheerio_1 = __webpack_require__(79);
var parse_1 = tslib_1.__importDefault(__webpack_require__(80));
/**
 ...
 *
 * @param content - Markup to be loadCheerioed.
 * @param options - Options for the created instance.
 * @param isDocument - Allows parser to be switched to fragment mode.
 * @returns The loadCheerioed document.
 * @see {@link https://cheerio.js.org#loadCheerioing} for additional usage information.
 */
function loadCheerio(content, options, isDocument) {
    if (isDocument === void 0) { isDocument = true; }
    if (content == null) {
        throw new Error('cheerio.loadCheerio() expects a string');
    }
    ...
    var loadCheerioedCheerio = /** @class */ (function (_super) {
        tslib_1.__extends(loadCheerioedCheerio, _super);
        function loadCheerioedCheerio() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        return loadCheerioedCheerio;
    }(cheerio_1.Cheerio));
    function initialize(selector, context, r, opts) {
        if (r === void 0) { r = root; }
        return new loadCheerioedCheerio(selector, context, r, tslib_1.__assign(tslib_1.__assign({}, internalOpts), options_1.flatten(opts)));
    }
    // Add in static methods & properties
    Object.assign(initialize, staticMethods, {
        loadCheerio: loadCheerio,
        // `_root` and `_options` are used in static methods.
        _root: root,
        _options: internalOpts,
        // Add `fn` for plugins
        fn: loadCheerioedCheerio.prototype,
        // Add the prototype here to maintain `instanceof` behavior.
        prototype: loadCheerioedCheerio.prototype,
    });
    return initialize;
}
exports.loadCheerio = loadCheerio;
...
var tslib_1 = __webpack_require__(2);
var options_1 = tslib_1.__importStar(__webpack_require__(5));
var cheerio_select_1 = __webpack_require__(7);
var htmlparser2_1 = __webpack_require__(48);
var parse5_adapter_1 = __webpack_require__(52);
var htmlparser2_adapter_1 = __webpack_require__(78);
/**
...
function html(dom, options) {
    ...
    /*
     * Sometimes `$.html()` is used without preloadCheerioing html,
...
function parseHTML(data, context, keepScripts) {
    ...
    var parsed = this.loadCheerio(data, options_1.default, false);
    if (!keepScripts) {
...
var css_what_1 = __webpack_require__(8);
var css_select_1 = __webpack_require__(11);
var DomUtils = __importStar(__webpack_require__(12));
var helpers_1 = __webpack_require__(46);
var positionals_1 = __webpack_require__(47);
// Re-export pseudo extension points
var css_select_2 = __webpack_require__(11);
...
var stringify_1 = __webpack_require__(10);
...
var subselects_1 = __webpack_require__(45);
...
var domhandler_1 = __webpack_require__(14);
...
var domhandler_1 = __webpack_require__(14);
var dom_serializer_1 = __importDefault(__webpack_require__(17));
var domelementtype_1 = __webpack_require__(15);
/**
 ...
 * Module dependencies
 */
var ElementType = __importStar(__webpack_require__(15));
var entities_1 = __webpack_require__(18);
/**
 ...
 */
var foreignNames_1 = __webpack_require__(26);
...
var decode_1 = __webpack_require__(19);
var encode_1 = __webpack_require__(25);
/**
...
var encode_2 = __webpack_require__(25);
...
var entities_json_1 = __importDefault(__webpack_require__(20));
var legacy_json_1 = __importDefault(__webpack_require__(21));
var xml_json_1 = __importDefault(__webpack_require__(22));
var decode_codepoint_1 = __importDefault(__webpack_require__(23));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_json_1 = __importDefault(__webpack_require__(24));
...
var aliases_1 = __webpack_require__(44);
...
var Tokenizer_1 = __webpack_require__(50);
...
exports.DomUtils = __importStar(__webpack_require__(12));
var FeedHandler_1 = __webpack_require__(51);
...
var Tokenizer_1 = __importDefault(__webpack_require__(50));
...
var domhandler_1 = __importDefault(__webpack_require__(14));
var DomUtils = __importStar(__webpack_require__(12));
var Parser_1 = __webpack_require__(49);
...
var tslib_1 = __webpack_require__(2);
var domhandler_1 = __webpack_require__(14);
var parse5_1 = __webpack_require__(53);
var parse5_htmlparser2_tree_adapter_1 = tslib_1.__importDefault(__webpack_require__(77));
...
const Parser = __webpack_require__(54);
const Serializer = __webpack_require__(76);
...
const Tokenizer = __webpack_require__(55);
const OpenElementStack = __webpack_require__(60);
const FormattingElementList = __webpack_require__(62);
const LocationInfoParserMixin = __webpack_require__(63);
const ErrorReportingParserMixin = __webpack_require__(68);
const Mixin = __webpack_require__(64);
const defaultTreeAdapter = __webpack_require__(72);
const mergeOptions = __webpack_require__(73);
const doctype = __webpack_require__(74);
const foreignContent = __webpack_require__(75);
const ERR = __webpack_require__(58);
const unicode = __webpack_require__(57);
...
const Preprocessor = __webpack_require__(56);
const unicode = __webpack_require__(57);
const neTree = __webpack_require__(59);
const ERR = __webpack_require__(58);
...
const Mixin = __webpack_require__(64);
const Tokenizer = __webpack_require__(55);
const LocationInfoTokenizerMixin = __webpack_require__(65);
const LocationInfoOpenElementStackMixin = __webpack_require__(67);
const HTML = __webpack_require__(61);
...
const Mixin = __webpack_require__(64);
const Tokenizer = __webpack_require__(55);
const PositionTrackingPreprocessorMixin = __webpack_require__(66);
...
const ErrorReportingMixinBase = __webpack_require__(69);
const ErrorReportingTokenizerMixin = __webpack_require__(70);
const LocationInfoTokenizerMixin = __webpack_require__(65);
const Mixin = __webpack_require__(64);
...
const ErrorReportingMixinBase = __webpack_require__(69);
const ErrorReportingPreprocessorMixin = __webpack_require__(71);
const Mixin = __webpack_require__(64);
...
const { DOCUMENT_MODE } = __webpack_require__(61);
...
var dom_serializer_1 = __webpack_require__(17);
...
var tslib_1 = __webpack_require__(2);
var parse_1 = tslib_1.__importDefault(__webpack_require__(80));
var options_1 = tslib_1.__importDefault(__webpack_require__(5));
var utils_1 = __webpack_require__(81);
var Attributes = tslib_1.__importStar(__webpack_require__(82));
var Traversing = tslib_1.__importStar(__webpack_require__(83));
var Manipulation = tslib_1.__importStar(__webpack_require__(84));
var Css = tslib_1.__importStar(__webpack_require__(85));
var Forms = tslib_1.__importStar(__webpack_require__(86));
var Cheerio = /** @class */ (function () {
    /**
     * Instance of cheerio. Methods are specified in the modules. Usage of this
     * constructor is not recommended. Please use $.loadCheerio instead.
     *
     * @private
    ...
    function Cheerio(selector, context, root, options) {
        ...
        var searchContext = !context
            ? // If we don't have a context, maybe we have a root, from loadCheerioing
                this._root
...
var static_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(81);
...
var tslib_1 = __webpack_require__(2);
var domhandler_1 = __webpack_require__(14);
var select = tslib_1.__importStar(__webpack_require__(7));
var utils_1 = __webpack_require__(81);
var static_1 = __webpack_require__(6);
var htmlparser2_1 = __webpack_require__(48);
 ...
 */
var domhandler_2 = __webpack_require__(14);
var parse_1 = tslib_1.__importStar(__webpack_require__(80));
var static_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(81);
var htmlparser2_1 = __webpack_require__(48);
/**
...
/******/ 			// no module.id needed
/******/ 			// no module.loadCheerioed needed
/******/ 			exports: {}
/******/ 		};
/******/ 	
...
(() => {
__webpack_require__.g.loadCheerio = (__webpack_require__(1).loadCheerio);
